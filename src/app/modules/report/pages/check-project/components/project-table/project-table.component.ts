...
import { CheckProjectStore } from '../../../../../check-project/store/reducers';
import { READ_CHECK_PROJECTS, SET_PROJECT } from '../../../../../check-project/store/actions';
...
export class ProjectTableComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    console.log("🚀 ~ file: project-table.component.ts:85 ~ ProjectTableComponent ~ ngOnInit ~ this.filtros:", this.filtros)
